...
def process_our_price(input_csv_path, output_csv_path, tx_hashes):
    df = pd.read_csv(input_csv_path)

    for transaction_hash in tx_hashes:
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        process_our_price(input_csv_path, output_csv_path, tx_hashes)
    else:
